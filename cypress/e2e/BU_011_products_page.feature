...
| communications |     1       |  Communications |            2         | Voice                   |           1              | SIP Trunking            |  /products/sip-trunks              |
| communications |     1       |  Communications |            2         | Voice                   |           2              | Voice API               |  /products/voice-api               |
| communications |     1       |  Communications |            3         | Numbers                 |           1              | Global Numbers          |  /products/phone-numbers           |
| communications |     1       |  Communications |            3         | Numbers                 |           2              | Toll-free Numbers       |  /products/toll-free-numbers       |
| communications |     1       |  Communications |            4         | Video                   |           1              | Video API               |  /products/video-api               |
| communications |     1       |  Communications |            5         | Identity                |           1              | Number Lookup API       |  /products/number-lookup            |
| communications |     1       |  Communications |            5         | Identity                |           2              | Verify API              |  /products/verify-api              |
| communications |     1       |  Communications |            6         | Fax                     |           1              | Fax API                 |  /products/fax-api                 |

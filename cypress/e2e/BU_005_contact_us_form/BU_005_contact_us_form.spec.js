...
import contactUsFormPage from "../pages/ContactUsFormPage.spec";
    ...
    Then("Verify contact us form with valid credentials", (datatable) => {       
        datatable.hashes().forEach((element) => {
          ...
          contactUsFormPage.setNameInput(element.first_name);
          ...
          contactUsFormPage.setAdditionalInformationInput(element.additional_information);
          contactUsFormPage.checkSubscriptionCheckbox();

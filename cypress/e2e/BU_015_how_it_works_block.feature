...
Then  Checking correct data in How it works subblock. Number: '<number>', title of the article: '<title_of_article>', description of the article: '<describe_of_article>'
Examples:
